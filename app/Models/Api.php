        ...
        foreach ($items as $item) {
            ...
            if ($item['media_type'] === 'tv') {
                $results[] = (object) [
                    ...
                    "adult" => $item["adult"],
                    "backdrop" => $item["backdrop_path"] ? $this->baseImgUrl . $item["backdrop_path"] : 'http://www.listercarterhomes.com/wp-content/uploads/2013/11/dummy-image-square.jpg',
                    ...
                    "poster" => $item["poster_path"] ? $this->baseImgUrl . $item["poster_path"] : 'http://www.listercarterhomes.com/wp-content/uploads/2013/11/dummy-image-square.jpg',
    ...
    public function getEpisodes(array $data) : Collection
    {
        $results = Arr::map(Arr::get($data, 'episodes'), function ($item) {
            return (object) [
                ...
                'poster' => $item["still_path"] ? $this->baseImgUrl . $item["still_path"] : 'http://www.listercarterhomes.com/wp-content/uploads/2013/11/dummy-image-square.jpg',
